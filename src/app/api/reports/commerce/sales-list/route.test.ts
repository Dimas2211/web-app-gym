...
// FASE VI-D6: sales-list ahora resuelve el contexto EFECTIVO vía
// resolveReportApiContext (que llama a resolveEffectiveApiContext) antes
// del module gate — se mockea para reproducir el mismo comportamiento
// PLATFORM_NATIVO de siempre (SESSION_USER no tiene auth_scope
// RUNTIME_CLIENT) sin depender de cookies()/next-headers en el entorno
// de test.
