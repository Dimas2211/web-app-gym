...
// ─────────────────────────────────────────────────────────────────
// commerce/inventory — error.tsx
//
// Boundary de error para el módulo de inventario.
// Captura errores de carga del servidor (fallo de DB en la carga
// inicial de product_locations en page.tsx).
//
// NOTA: Errores en fetch client-side (InventoryClient) se tratan
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[400px] text-center px-4">
      ...
      <p className="text-sm text-zinc-500 max-w-sm mb-6">
        Ocurrió un error al obtener los registros de inventario desde el servidor.
        Esto puede deberse a un problema de conexión con la base de datos.
      </p>
