...
export default async function EditClassTypePage({ params }: Props) {
  ...
  // cliente" redirige ANTES de cargar el registro — nunca se renderiza un
  // formulario de edición contra el tenant real del super_admin.
  ...
  try {
    ...
    const classType = await getClassTypeById(id, effectiveUser, context.client);
