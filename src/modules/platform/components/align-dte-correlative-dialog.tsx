...
// ─────────────────────────────────────────────────────────────────
// platform — align-dte-correlative-dialog.tsx
//
// F3-C24 — Diálogo para registrar el baseline externo de un
// correlativo DTE (último numeroControl usado en un sistema de
// facturación anterior). Solo super_admin.
// ─────────────────────────────────────────────────────────────────

import { useActionState, useEffect } from "react";
import { X, AlertTriangle } from "lucide-react";

import { alignDteCorrelativeAction } from "../actions/align-dte-correlative.action";
...
export function AlignDteCorrelativeDialog({ organizationId, row, onClose }: Props) {
  const [state, formAction, isPending] = useActionState(alignDteCorrelativeAction, undefined);
